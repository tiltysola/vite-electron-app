...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from '@/shadcn/components/animate-ui/components/animate/tooltip';
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from '@/shadcn/components/animate-ui/components/radix/sheet';
import {
  Highlight,
  HighlightItem,
} from '@/shadcn/components/animate-ui/primitives/effects/highlight';
